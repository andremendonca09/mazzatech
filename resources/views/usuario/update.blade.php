    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('usuario.showUpdateForm', $usuario->id) }}">
                        @csrf
                        @method("PUT")
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nome" type="text" class="form-control @error('nome') is-invalid @enderror" name="nome" value="{{ old('nome',$usuario->nome) }}" required autocomplete="nome" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="login" type="text" class="form-control @error('login') is-invalid @enderror" name="login" value="{{ old('login',$usuario->login) }}" required autocomplete="login">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <option value="{{$situacao->id}}"{{(old('situacao_usuario_id',$usuario->situacao_usuario_id)==$situacao->id ? " selected":"")}}>{{$situacao->descricao}}</option>
                                @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                Manter a senha em branco para não alterar
                                @error('senha')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
